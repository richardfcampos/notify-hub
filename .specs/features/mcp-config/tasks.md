...
**Commit**: `feat(mcp): shared tool registry with config management tools`
...
**Commit**: `feat(admin): mcp streamable http endpoint`
...
**Commit**: `feat(mcp): gateway registration docs and live smoke`
